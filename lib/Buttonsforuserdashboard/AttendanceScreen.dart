...
import 'calenderandhistory.dart';
import 'package:firstapp/Dashboards/Dashboardforuser.dart';
import 'idcard.dart';
...
class _AttendanceScreenState extends State<AttendanceScreen> {
  ...
  String location = "";
// for icons of attendnce date and profile
      ...
      body: Column(children: [
        Expanded(
          ...
          child: Column(
            children: [
              IndexedStack(
                index: currentIndex, // The index of the widget to show
                children: [
                  // Add your widgets to the IndexedStack
                ],
              ),
