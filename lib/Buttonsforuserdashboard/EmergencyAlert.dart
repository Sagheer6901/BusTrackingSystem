...
class EmergencyPortal extends StatelessWidget {
  CollectionReference emergencyPortal =
      FirebaseFirestore.instance.collection('Tbl_EmergencyAlert');
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Dashboardforuser()));
                    },
                    child: const Text(
                      'Go back',
                      style: TextStyle(
