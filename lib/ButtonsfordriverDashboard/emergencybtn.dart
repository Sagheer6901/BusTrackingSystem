...
class DriverEmergencyPortal extends StatelessWidget {
  CollectionReference driveremergencyPortal =
      FirebaseFirestore.instance.collection('Tbl_EmergencyAlert_driver');

  void showToast() {
    Fluttertoast.showToast(
        msg: "Emergency Message Sent Succesfully",
          ...
          Align(
            ...
            child: Container(
              ...
              child: FloatingActionButton.extended(
                ...
                onPressed: () async {
                  await driveremergencyPortal.add({
                    'Driver_Id': globals.Driverid,
                    'Emergency': emergencyMessage,
                    'Emergency_Date': DateFormat().format(DateTime.now())

                    // ignore: avoid_print
                  }).then((value) => print('Emetgecy Message Sent'));
                  showToast();
                },
                label: const Text(
                  'Submit',
