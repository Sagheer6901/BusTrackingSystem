...
import 'package:firstapp/Buttonsforuserdashboard/MainAttendnceandhistory.dart';
import 'package:firstapp/Buttonsforuserdashboard/calenderandhistory.dart';
import 'package:firstapp/Buttonsforuserdashboard/uploadpicture.dart';
...
//const int SESSION_TIMEOUT = 25; // 5 minutes in seconds
const int SESSION_TIMEOUT = 2 * 60; // 5 minutes in seconds
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.pushReplacement(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              const MainAttendanceandhistoryscreen()));
                },
                child: const Text(
                  'Attendance',
                  style: TextStyle(
