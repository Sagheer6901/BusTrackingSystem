...
class fetchemergencyStudentPage extends StatefulWidget {
  const fetchemergencyStudentPage({Key? key}) : super(key: key);

  @override
  fetchemergencyStudentPageState createState() =>
      fetchemergencyStudentPageState();
}

class fetchemergencyStudentPageState extends State<fetchemergencyStudentPage> {
  // to get all the documents in collection
  final Stream<QuerySnapshot> studentsStream =
      FirebaseFirestore.instance.collection('Tbl_EmergencyAlert').snapshots();
